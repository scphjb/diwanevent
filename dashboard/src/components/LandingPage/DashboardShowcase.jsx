...
const DashboardShowcase = () => {
  ...
  return (
    <section className="py-24 bg-brand-dark overflow-hidden relative" id="dashboard-showcase">
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <motion.div
            ...
            className={`absolute -bottom-10 glass-card p-6 rounded-3xl shadow-2xl border border-brand-border hidden md:flex items-center gap-6 z-20 ${isRtl ? '-left-10 flex-row-reverse' : '-right-10'}`}
          >
            <div className={`flex items-center gap-4 ${isRtl ? 'pl-6 border-l' : 'pr-6 border-r'} border-white/10 last:border-0`}>
