    ...
    <div className="bg-white/5 border border-white/10 rounded-[40px] p-10 backdrop-blur-xl">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="space-y-6">
            ...
            return (
              <div key={data.name} className="space-y-2">
                <div className="flex justify-between text-sm font-bold">
                  <span className="text-emerald-100">{data.name}</span>
          ...
          <div className="pt-6 border-t border-white/5 text-center text-emerald-400/30 text-sm">
            ...
            <BarChart data={chartData}>
              ...
              <Bar dataKey="votes" radius={[10, 10, 0, 0]}>
                {chartData.map((entry, index) => (
                  <Cell key={`cell-${index}`} fill={index === 0 ? '#D4AF37' : '#10B981'} opacity={0.8} />
                ))}
              </Bar>
            </BarChart>
          </ResponsiveContainer>
