    ...
    if (message.type === 'admin_notification') {
      ...
      toast.custom((t) => (
        <div
          ...
          } max-w-md w-full bg-[#022C22]/90 backdrop-blur-xl border border-white/10 shadow-2xl rounded-[24px] pointer-events-auto flex ring-1 ring-black ring-opacity-5`}
        >
