      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
        {[
          ...
          >
            ...
            <div className="text-emerald-400/30 text-sm font-bold uppercase tracking-wider">{stat.label}</div>
          </motion.div>
        ))}
      </div>
          ...
          <div className="h-[300px] w-full">
            <ResponsiveContainer width="100%" height="100%">
              <AreaChart data={data.peaks}>
                ...
                <Tooltip 
                  contentStyle={{ backgroundColor: '#022C22', border: '1px solid #ffffff10', borderRadius: '16px' }}
              ...
              {data.councils_distribution.slice(0, 4).map((c, i) => (
                <div key={i} className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm text-emerald-100/70 truncate max-w-[120px]">{c.name}</span>
                  </div>
