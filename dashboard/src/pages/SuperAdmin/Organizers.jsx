  ...
  return (
    <div className="space-y-8" dir="rtl">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
        ...
        <button className="flex items-center gap-3 bg-[#D4AF37] text-[#022C22] px-8 py-4 rounded-2xl font-black shadow-xl shadow-[#D4AF37]/20 hover:bg-[#F0C040] hover:scale-105 transition-all">
          <UserPlus size={20} />
      ...
      {/* Organizers Table */}
      <div className="bg-[#0A3D2B] rounded-[2.5rem] border border-white/5 overflow-hidden">
        {loading ? (
            ...
            <tbody className="divide-y divide-white/5">
                ...
                <tr key={org.id} className="hover:bg-white/[0.02] transition-colors group">
                    ...
                    <div className="flex justify-center gap-3">
                        ...
                        <button className="p-2 hover:bg-white/10 rounded-lg text-[#F0F4F2]/40 hover:text-white transition-all">
