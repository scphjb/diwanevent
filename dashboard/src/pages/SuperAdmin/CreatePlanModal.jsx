      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-6">
          ...
          <motion.div
            ...
            className="relative w-full max-w-2xl bg-[#0D1527] border border-white/10 rounded-[2.5rem] shadow-2xl overflow-hidden"
          >
            ...
            <div className="p-8 border-t border-white/5 flex gap-4 bg-white/5">
              ...
              <button
                ...
                disabled={loading}
                className="flex-grow py-4 bg-[#D4AF37] text-[#050B18] font-black rounded-2xl hover:bg-[#D4AF37]/90 transition-all flex items-center justify-center gap-2"
              >
                {loading ? (
                  <div className="w-5 h-5 border-2 border-[#050B18]/20 border-t-[#050B18] rounded-full animate-spin" />
                ) : (
                  <>
                    <Save size={18} />
                    حفظ الباقة
